...
func (*ModelMetadataResponse_TensorMetadata) Descriptor() ([]byte, []int) {
	return file_inference_proto_rawDescGZIP(), []int{9, 0}
}
...
func (*ModelInferRequest_InferInputTensor) Descriptor() ([]byte, []int) {
	return file_inference_proto_rawDescGZIP(), []int{10, 0}
}
...
func (*ModelInferRequest_InferRequestedOutputTensor) Descriptor() ([]byte, []int) {
	return file_inference_proto_rawDescGZIP(), []int{10, 1}
}
...
func (*ModelInferResponse_InferOutputTensor) Descriptor() ([]byte, []int) {
	return file_inference_proto_rawDescGZIP(), []int{11, 0}
}
...
var file_inference_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
...
func file_inference_proto_init() {
	...
	file_inference_proto_msgTypes[12].OneofWrappers = []interface{}{
